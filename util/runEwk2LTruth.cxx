...
void help() {
  ...
  printf("\tisSignal\t:\t%s\n","Bool for SUSY signal, default = 0");
...
int main( int argc, char* argv[] ) {
  ...
  Ewk2LTruthAnalysis* alg = new Ewk2LTruthAnalysis();
  ...
  if(!submitToGrid) {
    ...
    // User sample
    driver.options()->setString("nc_outputSampleName", prodTag); //"user.amete."+prodTag+".%in:name[4]%.%in:name[6]%");
