...
int main( int argc, char* argv[] ) {
  ...
  WWbbTruthAnalysis* alg = new WWbbTruthAnalysis();
  ...
  if(!submitToGrid) {
    ...
    // Official sample
    //driver.options()->setString("nc_outputSampleName", "user.dantrim."+prodTag+".%in:name[2]%.%in:name[6]%");
    // User sample
    driver.options()->setString("nc_outputSampleName", "user.dantrim."+prodTag+".%in:name[4]%.%in:name[5]%");
