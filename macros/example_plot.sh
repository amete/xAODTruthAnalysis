...
# lvlv
#python make_plots.py -i "Sherpa_221_llvv" -w "0,9,5,8,6" -v "${var}" -r "ST2L_incVV_SF,ST2L_incVV_DF" -f "eps" -l 35000 -b -a -L; 
# Top
#python make_plots.py -i "PowhegPy_ttbar,PowhegPy_ttbar_radHi,PowhegPy_ttbar_radLo,aMCatNLOHpp_ttbar,PowhegHpp_ttbar,Sherpa_dilep_ttbar" -v "${var}" -r "ST2L_incTT_ALL" -f "eps" -l 35000 -b -a -L; 
#python make_plots.py -i "PowhegPy_ttbar,aMCatNLOHpp_ttbar,Sherpa_dilep_ttbar" -v "${var}" -r "ST2L_incTT_ALL" -f "eps" -l 35000 -b -a -L; 
python make_plots.py -i "PowhegPy_ttbar,aMCatNLOHpp_ttbar" -v "${var}" -r "ST2L_incTT_ALL" -f "eps" -l 35000 -b -a -L; 
...
#python make_plots.py -i "PowhegPy_ttbar,PowhegPy_ttbar_radHi,PowhegPy_ttbar_radLo,aMCatNLOHpp_ttbar,PowhegHpp_ttbar" -v "${var}" -r "ST2L_incTT_DF" -f "eps" -l 35000 -b -a -L; 
